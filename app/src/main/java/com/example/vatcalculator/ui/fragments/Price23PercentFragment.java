...
import com.example.vatcalculator.databinding.FragmentPrice23PercentBinding;
...
public class Price23PercentFragment extends Fragment {

    private FragmentPrice23PercentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentPrice23PercentBinding.inflate(inflater, container, false);
    ...
    private Observer<String> fieldValuesGrossPriceChangeObserver() {
        return grossPrice -> {
            if (Objects.isNull(grossPrice)) {
                ...
                Optional<CalculatedPrice> calculatedPrice = VatAndNetValueCalculator.calculate(grossPrice, VatValue.VAT_23_Percent);
